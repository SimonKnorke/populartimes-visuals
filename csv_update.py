...
for i in df1.iterrows():
    ...
    if "current_popularity" in data:
        pickle.dump([i[1][0], i[1][1], i[1][2], i[1][3], data], open(f"dumps//{i[1][0]}_{i[1][1]}_{i[1][2]}_{dt_string}.p", "wb"))
...
df_dict = {"City": cities, "Type": types, "Place": places, "Timestamp": timestamp,
